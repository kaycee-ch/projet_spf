...
package sgf is
   ...
   noeud_courant, arbre : T_arbre;

   procedure formatage_disque(arbre : out T_arbre);
   ...
   procedure creer_fichier(noeud_courant : in out T_arbre; arbre : in out T_arbre; path : in String; name : in String; file_info : in out T_info);
